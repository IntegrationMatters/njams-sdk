...
public class GetTracing extends ConfigurationInstructionProcessor {

    private static final Logger LOG = LoggerFactory.getLogger(GetTracing.class);

    public static final String GET_TRACING = Command.GET_TRACING.commandString();

    public GetTracing(Configuration configuration, String commandToProcess) {
