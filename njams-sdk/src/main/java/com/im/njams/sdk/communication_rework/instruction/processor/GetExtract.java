...
public class GetExtract extends ConfigurationInstructionProcessor {

    private static final Logger LOG = LoggerFactory.getLogger(GetExtract.class);

    public static final String GET_EXTRACT = Command.GET_EXTRACT.commandString();

    public GetExtract(Configuration configuration, String commandToProcess) {
