...
| `njams.sdk.flushsize`                            | `5242880`  | Approximate maximum log message body size in bytes. The message is flushed when the estimated size exceeds this threshold. The size estimate accounts for every activity's base size, event messages, event codes and attributes, in addition to payloads, stack traces and start data.                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                      |
